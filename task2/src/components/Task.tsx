...
export const Task = ({ value, openModal, changeTaskValue }: Props) => {
 ...
 const colors = ['teal', 'cyan', 'lime', 'emerald', 'sky']
  ...
  return (
    ...
    <div className={`bg-${colors[data.backgroundId]}-500 text-black mb-4 rounded-lg min-h-[130px] max-w-[900px] min-w-[400px] py-3 text-2xl flex flex-col relative`}>
